...
/**
 * Icon name: delete_outline-24px
 */
export const DeleteIcon: React.FC<ComponentProps> = ({ id, className, ...props }) => (
	<svg id={id} className={combineClassNames("icon delete-icon", className, "light-background")} viewBox="0 0 24 24" {...props}>
